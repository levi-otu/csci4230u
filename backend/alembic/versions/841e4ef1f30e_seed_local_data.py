"""Seed local data - books and clubs

Revision ID: 841e4ef1f30e
Revises: f35327670f79
Create Date: 2025-11-28 03:30:00.000000
...
revision = '841e4ef1f30e'
down_revision = 'f35327670f79'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    # ========== SEED BOOKS ==========
    # Insert sample books from local database
    op.execute("""
...
Translation of Voǐna i mir.',
    ...
    # ========== SEED CLUBS ==========
    # Insert clubs from local database
    # Note: These will be owned by the admin user created in migration 379a81d365b7
    # The admin user ID may be different in production, so we use a subquery to get it
    op.execute("""
        -- Get the admin user ID (created in migration 379a81d365b7)
        DO $$
        DECLARE
            admin_user_id uuid;
        BEGIN
            ...
            -- Insert clubs with the admin user as creator
            INSERT INTO clubs (id, name, description, topic, created_by, is_active, max_members, created_at, updated_at)
            VALUES 
                ('777ebbb6-e083-4337-9539-62db50c63668'::uuid, 'The Inklings', 'A ground for the discussion of what is lovely, beautiful and genuinely Good.', 'All encompassing', admin_user_id, true, NULL, '2025-11-23T02:38:23.421079'::timestamp, '2025-11-23T02:38:23.421086'::timestamp),
                ('1ab87609-068b-4990-b943-f4bcfcfe3604'::uuid, 'The Classics Crew', 'A club for the sole purpose of studying the wisdom of classic literature.', 'Classic Literature', admin_user_id, true, NULL, '2025-11-23T02:47:28.680076'::timestamp, '2025-11-23T02:47:28.680082'::timestamp),
                ('681ff682-f876-40d0-bfda-994197a879e1'::uuid, 'Mens Bible Study', 'A group of men gathering to indulge in the boundless truths of Gods Word.', 'Theology', admin_user_id, true, NULL, '2025-11-23T03:46:28.316326'::timestamp, '2025-11-23T03:46:28.316333'::timestamp)
            ON CONFLICT (id) DO NOTHING;
            
            -- Add admin user to all clubs as member
            INSERT INTO user_clubs (user_id, club_id, joined_at)
            VALUES 
                (admin_user_id, '777ebbb6-e083-4337-9539-62db50c63668'::uuid, '2025-11-23T02:38:23.421079'::timestamp),
                (admin_user_id, '1ab87609-068b-4990-b943-f4bcfcfe3604'::uuid, '2025-11-23T02:47:28.680076'::timestamp),
                (admin_user_id, '681ff682-f876-40d0-bfda-994197a879e1'::uuid, '2025-11-23T03:46:28.316326'::timestamp)
