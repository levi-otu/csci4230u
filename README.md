...
If we can get ambitious we will attempt to implement Amazons WebRTC for real-time video streaming. We'll add some CI/CD pipelines to allow for the deployment of new versions and set automated deployment dependent on tests passing.
